...
class TestCase(BaseCase):
	...
	desc = "老师抢单后悔单"
	caseData = {
		'students' : ['11266660103'],
		'teachers' : ['11166660103'],
	...
	def run(self):
		...
		self.regretorder(self.teachers)
		assert self.checkCallbacks(self.students[0],['st_onnotifytccancelorder']) is True,"receive unexpect callbacks\
		:received callbacks:%s,expected callbacks:%s" %(self.callbacks['student'][self.students[0]],['st_onnotifytccancelorder'])
