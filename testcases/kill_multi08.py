...
class TestCase(BaseCase):
	level = 1
	desc = "老师抢单成功后，老师杀进程，学生是否能收到老师peerdisconnect和老师cancleorder通知"
	caseData = {
		'students' : ['11266660158'],
		'teachers' : ['11166660158'],
	...
	def run(self):
		...
		:received callbacks:%s,expected callbacks:%s" %(self.callbacks['teacher'][self.teachers[0]],['st_onnotifytccancelorder','st_onnotifypeerdisconnect','st_onlogout'])
		self.clearCallbacks()
